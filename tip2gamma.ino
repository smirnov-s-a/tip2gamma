...
int shortDelay = 100; //время задержки короткого нажатия, ms
...
static const uint8_t C[6][15] = {
  ...
  {0x00, 0x00, 0xFF, 0x5D, 0x55, 0x77, 0x77, 0x5D, 0x55, 0xD7, 0x55, 0x75, 0xD7, 0x77, 0x77}
};//down
...
void loop() {
  ...
  if ((Button_Now != Pressed_Button) && (Pressed_Button == 0)) {
    Pressed_Time = millis();
  }
